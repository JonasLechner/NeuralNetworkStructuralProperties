...
public class RandomRotatingEdgeGenerator {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder stringBuilder = new StringBuilder("testing/RandomRotatingEdge" + inputNodes + "_");
        ...
        try {
            ...
            System.out.println("RandomRotatingEdge network generated successfully in " + outputFile);
        } catch (IOException e) {
            System.err.println("Error generating RandomRotatingEdge network: " + e.getMessage());
        }
    }
    ...
    private static List<Integer> generateIndices(int range, double sparsity) {
        ...
        while (usedIndices.size() < numFilled) {
