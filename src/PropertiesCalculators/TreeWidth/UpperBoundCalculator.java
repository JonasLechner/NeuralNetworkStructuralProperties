...
public class UpperBoundCalculator {
    public static void main(String[] args) {
        ...
        UpperBound<GraphInput.InputData> ub = new AllStartLexBFS<>();
        stopwatch.reset();
        stopwatch.start();
        ub.setInput(g);
        ub.run();
        ...
        System.out.println("");
        //
        /*Permutation p = new AllStartLexBFS();
        p.setInput(g);
        ub = new PermutationToTreeDecomposition<>(p.getPermutation());
        stopwatch.reset();
        stopwatch.start();
        ub.setInput(g);
        ub.run();
